...
Homebrew taps must be public — `brew tap` can't read private repos
without auth. This is the only Veirox repo intentionally open to the
world; the binary source itself stays in a private repo.
